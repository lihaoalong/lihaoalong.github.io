...
class DataSyncManager {
    ...
    saveDataToFile() {
        ...
        const exportFileDefaultName = 'blog_data.json';
            ...
            <div class="link-item" data-id="${link.id}">
                <div class="link-header">
                    ...
                    <div class="link-actions">
                        <button class="edit-btn" onclick="dataSyncManager.editLink(${link.id})">编辑</button>
                        <button class="delete-btn" onclick="dataSyncManager.deleteLink(${link.id})">删除</button>
                    </div>
                </div>
                ...
                <div class="edit-form" id="edit-form-${link.id}" style="display: none;">
                    ...
                    <button onclick="dataSyncManager.saveEdit(${link.id})">保存</button>
                    <button type="button" onclick="dataSyncManager.cancelEdit(${link.id})">取消</button>
                </div>
            </div>
        `).join('');
    }
                ...
                <div class="blog-header">
                    ...
                    <div class="blog-meta">
                        ...
                        <div class="blog-actions">
                            <button class="edit-btn" onclick="dataSyncManager.editBlogPost(${post.id})">编辑</button>
                            <button class="delete-btn" onclick="dataSyncManager.deleteBlogPost(${post.id})">删除</button>
                        </div>
                    </div>
                </div>
    ...
    bindEvents() {
        ...
        // 数据同步事件
        document.getElementById('syncToRemote').addEventListener('click', () => {
            this.saveDataToFile();
        });

        document.getElementById('syncFromRemote').addEventListener('click', () => {
            // 创建一个隐藏的文件输入元素
    ...
    editBlogPost(id) {
        ...
        postElement.innerHTML = `
            <div class="blog-header">
                ...
                <div class="blog-meta">
                    <div class="blog-actions">
                        <button class="edit-btn" onclick="dataSyncManager.saveEditBlogPost(${post.id})">保存</button>
                        <button class="delete-btn" onclick="dataSyncManager.cancelEditBlogPost(${post.id})">取消</button>
                    </div>
                </div>
            </div>
            <div class="edit-form">
